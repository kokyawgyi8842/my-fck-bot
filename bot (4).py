...
BOT_TOKEN ="8910901438:AAENIw8TZ4vkqo8HfG5CT0a0xabNNtfqjSM"
ADMIN_ID ="7756989960"
...
waiting_for = {}  # {chat_id: "setup_url" | "genkey_duration" | "genkey_userid" | "proxy_url" | "brute_target" | "brute_plan"}
admin_genkey_temp = {}  # {chat_id: {"duration": ..., "user_id": ...}}
brute_temp = {}  # {chat_id: {"mode": ..., "target": ..., "plan_filters": []}}
...
# ══════════════════════════════════════════════════════════════════════════
# ── TEXT INPUT HANDLER (for waiting states) ───────────────────────────────
# ══════════════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════════════
# ── LEGACY COMMANDS (button နှင့် command နှစ်ခု အလုပ်လုပ်သည်) ───────────────
# ══════════════════════════════════════════════════════════════════════════
